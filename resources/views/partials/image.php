<a class="card-link" href="<?= e($image->paths['full']) ?>" aria-label="Open image <?= e($image->title) ?>">
    <article class="card" tabindex="0">
        <img src="<?= e($image->paths['thumbnail']) ?>" alt="<?= e($image->title) ?>">
        <p>
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                    ...
                    <path d="M22 16a6 6 0 1 1-12 0a6 6 0 1 1 12 0" />
                </g>
            </svg>
            <?= e(format_time($image->createdAt)) ?>
        </p>
        <?php if ($image->author) : ?>
            <p class="truncatable">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
